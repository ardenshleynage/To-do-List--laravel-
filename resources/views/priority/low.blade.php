        ...
        <div class="card">
            ...
            <ul class="list">
                ...
                @if ($tasks->isEmpty())
                    ...
                    <li>
                        <div class="no-tasks">No tasks for low level</div>
                    </li>
                @else
                    <!-- Header Row -->
                    <li>
                        ...
                        <li>
                            <div class="center_content task-row">
                                ...
                                <div class="center_content2">
                                    <small class="check{{ $task->id }}" onclick="checked({{ $task->id }})"></small>
                                    <strike id="strike{{ $task->id }}" class="strike_none">{{ $task->title }}</strike>
                                </div>
                                ...
                                <div class="center_content2">
                                    <a href="{{ route('alert', $task->id) }}"><button type="submit" class="button">Delete</button></a>
                                    <a href="{{ route('tasks.edit', $task->id) }}"><button type="submit" class="button">Edit</button></a>
                                </div>
                            </div>
                        </li>
                    @endforeach
